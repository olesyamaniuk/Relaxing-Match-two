document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".relaxing-navigation-list");
  const headerRef = document.querySelector(".relaxing-header");
  const navigationRef = document.querySelector(".relaxing-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".relaxing-toggle-button img");
